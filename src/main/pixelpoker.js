...
const Content = () =>{
    return(
        ...
        marginTop="10">
            ...
            <Text 
            color={useColorModeValue('blackAlpha.700','white')} marginTop="10">As it said, the rule is simple, now just try to run the exe file.</Text>     
            ...
            marginBottom="10">
                <Text
                color={useColorModeValue('blackAlpha.700','white')}>Flaredle</Text>
            </Button>
            </Link>
            ...
            marginBottom="10">
                <Text
                color={useColorModeValue('blackAlpha.700','white')}>Magic 8 Ball</Text>
            </Button>
            </Link>
            </Flex>
            </Grid>
